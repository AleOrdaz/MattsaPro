...
class CustomExpansionPanelList extends StatelessWidget {
  ...
  final double radioBox;
  final double radioBigBox;
  ...
  Widget build(BuildContext context) {
    ...
    for (int index = 0; index < children.length; index += 1) {
      ...
      double _radiusValue = _isChildExpanded(index) ? radioBox : radioBigBox;
            ...
            child: Container(
              decoration: BoxDecoration(
                  ...
                  borderRadius: new BorderRadius.only(
                      bottomLeft: new Radius.circular(_radiusValue),
                      topLeft: new Radius.circular(_radiusValue))),
